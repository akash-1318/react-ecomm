...
import {
  ...
  removeFromCart,
  updateQty,
} from "../../pages/cart/cart-functions";
import {
  addToWishlist,
  deleteWishlistData,
      ...
      <div className="card__container card__container-horizontal">
        ...
        <div className="card__name mycart">
          <div className="mycart__product-desc">
            <p className="product__name">{prod.name}</p>
            <p className="selling__price">₹{prod.price}</p>
            ...
            <div className="quantity__div">
              ...
              <div className="number">{prod.qty}</div>
              <button
                className="increment"
                onClick={() =>
            ...
            <div className="mycart__card-btn">
              ...
              <button
                ...
                onClick={() => removeFromCart(prod, cartDispatch, authToken)}
              >
                Remove from cart
              </button>

              {wishState.wishlistProducts.find(
                (item) => item._id === prod._id
              ) ? (
                <button
                  class="btn secondry__ouline-btn mycart"
                  onClick={() =>
                    deleteWishlistData(prod, wishDispatch, authToken)
                  }
                >
